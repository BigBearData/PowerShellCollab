...
try { Invoke-Command -ComputerName $ServerName -ScriptBlock { Write-Error "err" } -ErrorAction Stop } catch { Write-Host "Invoke-Command does not work for $ServerName, using the -ComputerName parameter" -ForegroundColor Red }
...
Runs the command OIS_XML_GetSQLConfig -Command SSIS
...
Runs the command OIS_XML_GetSQLConfig -Command Server
...
Runs the command OIS_XML_GetESConfig -Command DBUser
...
Runs the command OIS_XML_GetESConfig -Command DBName
...
Runs the command OIS_XML_GetOPSConfig -Command DBUser
...
Runs the command OIS_XML_GetODWConfig -Command DBUser
...
Runs the command OIS_XML_GetRoPEConfig -Command DBUser
...
Runs the command OIS_XML_GetServiceConfig -Command UserName
...
Runs the command OIS_XML_GetAdministratorConfig -Command UserName
